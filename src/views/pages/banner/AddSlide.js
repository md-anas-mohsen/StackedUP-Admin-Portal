...
import { CAlert, CButton, CCard, CCardBody, CCardHeader, CCol, CForm, CFormControl, CFormLabel, CSpinner } from '@coreui/react'
...
const AddSlide = () => {
    ...
    useEffect(() => {
        if (error) {
            if(error === "Cannot read property 'length' of undefined") setAlert({type: "danger", message: "Please add an image"})
            ...
            <CCardBody>
                <CForm className="row g-3" onSubmit={handleSubmit}>
                    <CCol md="12">
                        ...
                        <CFormControl type="text" value={title} onChange={(e) => setTitle(e.target.value)} id="slide-title" />
                    </CCol>
                    <CCol xs="12">
                    ...
                    <CCol md="12">
                        ...
                        <CFormControl type="text" value={link} onChange={(e) => setLink(e.target.value)} id="slide-link" />
                    </CCol>
                    <CCol xs="12">
                    ...
                    <CCol xs="12">
                        <center>
                        {image !== "" && <img style={{objectFit: "contain", width: "300px", height: "300px"}} src={image} alt=""></img>}
                        </center>
                    </CCol>
                    <CCol xs="12">
