...
import { CAlert, CButton, CCard, CCardBody, CCardHeader, CCarousel, CCarouselItem, CCol, CForm, CFormCheck, CFormControl, CFormLabel, CFormSelect, CSpinner } from '@coreui/react'
                        ...
                        {oldImages.length > 1 ? (
                            <CCarousel indicators dark>
                                {oldImages.map((image, i) => (
                                    <CCarouselItem key={i}>
                                        <img style={{objectFit: "contain", width: "300px", height: "300px"}} src={image.url} alt={`slide ${i+1}`}></img>
                                    </CCarouselItem>
                                ))}
                            </CCarousel>
                        )
                        :oldImages.length === 1 && <img style={{objectFit: "contain", width: "300px", height: "300px"}} src={oldImages[0].url} alt=""></img>}
