...
const ProductReviews = ({ match }) => {
    ...
    const { error: reviewError, isDeleted, loading: reviewLoading } = useSelector(state => state.review);
      ...
      return (
        ...
        >
          ...
          <CModalFooter>
            ...
            <CButton disabled={loading || reviewLoading} color="danger" onClick={() => handleDeleteReview(toDelete)}>Delete</CButton>
          </CModalFooter>
        </CModal>
      )
    }
    ...
    return (
        ...
        <CCard className="mb-4">
            ...
            <CCardBody>
              <ConfirmDelete />
              {!loading && product && reviews ? <Table columns={columns} rows={rows} /> 
